                      ...
                      <form action="/admin/member/modName" method="get">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control"
                            disabled="disabled" value="${user.userid }">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">수정할
                    ...
                    <td colspan="8">
                      ...
                      <form name="authList"
                        ...
                        <input type="hidden" name="userid"
                          ...
                          value="ROLE_USER">일반회원</input> <input
                          type="checkbox" name="authList"
                          value="ROLE_ADMIN">관리자</input> <input
                          type="checkbox" name="authList"
                          value="ROLE_MANAGER">매니저</input> <input
                          type="checkbox" name="authList"
                          value="ROLE_ENGINEER">엔지니어</input> <input
                          type="submit" value="변경">
                      </form>
                    </td>
                  </tr>
